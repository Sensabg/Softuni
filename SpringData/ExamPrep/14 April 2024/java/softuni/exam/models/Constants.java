...
public class Constants {
    ...
    public static final String SUCCESSFUL_DEVICE_IMPORT = "Successfully imported %s of type %s with brand %s";
    public static final String SUCCESSFUL_SALE_IMPORT = "Successfully imported %s with number %s";
